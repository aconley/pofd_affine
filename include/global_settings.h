...
*/
namespace pofd_mcmc {
  const char version[] = "0.3.1"; //!<Version number of P(D) library
  ...
  enum pofd_messages { BEAMSENDPIXSIZE=1000, BEAMSENDMINVAL=1001,
		       ...
		       CLSENDCFIRBPRIORSIGMA=5016, CLSENDHASSIGMAPRIOR=5017, 
		       CLSENDSIGMAPRIORWIDTH=5018, CLSENDNINTERP=5019, 
		       CLSENDNBEAM=5020, CLSENDSETNUM=5021, 
		       CLSENDBINDATA=5022, CLSENDNBINS=5023,
		       ...
		       CLDSENDNBINS=5126, CLDSENDHASCFIRBPRIOR1=5127,
		       CLDSENDCFIRBPRIORMEAN1=5128, 
		       CLDSENDCFRIBPRIORSIGMA1=5129, CLDSENDHASCFIRBPRIOR2=5130,
		       CLDSENDCFIRBPRIORMEAN2=5131, 
		       CLDSENDCFRIBPRIORSIGMA2=5132, CLDSENDHASSIGMAPRIOR1=5133,
		       CLDSENDSIGMAPRIORWIDTH1=5134, CLDSENDHASSIGMAPRIOR2=5135,
		       CLDSENDSIGMAPRIORWIDTH2=5136,
