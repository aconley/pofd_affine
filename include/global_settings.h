...
namespace pofd_mcmc {
  ...
  enum pofd_messages { BEAMSENDPIXSIZE=1000, BEAMSENDMINVAL=1001,
		       ...
		       DOUBLEBEAMSENDHASSIGN=1502, DOUBLEBEAMSENDNPIX=1503,
		       DOUBLEBEAMSENDPIXARR1=1504,DOUBLEBEAMSENDPIXARR2=1505, 
		       DOUBLEBEAMSENDIPIXARR1=1506,DOUBLEBEAMSENDIPIXARR2=1507,
		       DOUBLEBEAMSENDNBINS=1508, 
		       DOUBLEBEAMSENDISHISTOGRAMMED=1509,
		       DOUBLEBEAMSENDNHIST=1510, DOUBLEBEAMSENDBINWEIGHTS=1511,
		       DOUBLEBEAMSENDBINVALS1=1512, DOUBLEBEAMSENDBINVALS2=1513,
		       DOUBLEBEAMSENDTOT1=1514,DOUBLEBEAMSENDTOT2=1515,
		       DOUBLEBEAMSENDTOTSQ1=1516,DOUBLEBEAMSENDTOTSQ2=1517,
