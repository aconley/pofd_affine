...
/*!
  \brief P(D) convenience variables and constants
*/
namespace pofd_mcmc {
  const char version[] = "0.5.1"; //!<Version number of P(D) library
  ...
  // Note: this list is generated by script!
  // Also: I don't use enum class here because MPI doesn't like it --
  //  it expects tags to be integers, not enum classes.
  ...
  enum pofd_messages { BEAMSENDPIXSIZE=1000, BEAMSENDMINVAL=1001,
                       ...
                       NCDCSENDMINSIGMA=2511, 
                       NCDCSENDOPLOADED=2512, NCDCSENDNOFFSETKNOTS=2513,
                       NCDCSENDOFFSETKNOTS=2514, NCDCSENDOVLOADED=2515,
                       NCDCSENDOFFSETVALS=2516,
...
// Should maybe replace with Tuple at some point
